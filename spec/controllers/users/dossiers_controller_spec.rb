describe Users::DossiersController, type: :controller do
  ...
  describe "#create_commentaire" do
    ...
    before do
      ...
      create(:assign_to, instructeur: instructeur_with_instant_message, procedure: procedure, instant_email_notifications_enabled: true, groupe_instructeur: procedure.defaut_groupe_instructeur)
      create(:assign_to, instructeur: instructeur_without_instant_message, procedure: procedure, instant_email_notifications_enabled: false, groupe_instructeur: procedure.defaut_groupe_instructeur)
    end
